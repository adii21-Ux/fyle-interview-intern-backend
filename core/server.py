...
from core.apis.assignments import student_assignments_resources, teacher_assignments_resources, prinicipal_assignment_resources
...
app.register_blueprint(prinicipal_assignment_resources, url_prefix='/principal')
